...
{	
	...
	static void* (*Realloc)(void* Ptr, SIZE_T Count, uint32 Alignment) = decltype(Realloc)(__int64(GetModuleHandleW(0)) + 0x1a1927c);

	static void* (*FreeMem)(void* a1) = decltype(FreeMem)(__int64(GetModuleHandleW(0)) + 0xafe310);
