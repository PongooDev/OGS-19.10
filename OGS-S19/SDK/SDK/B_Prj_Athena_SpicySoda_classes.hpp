...
static_assert(alignof(AB_Prj_Athena_SpicySoda_C) == 0x000008, "Wrong alignment on AB_Prj_Athena_SpicySoda_C");
static_assert(sizeof(AB_Prj_Athena_SpicySoda_C) == 0x000AC0, "Wrong size on AB_Prj_Athena_SpicySoda_C");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, UberGraphFrame_B_Prj_Athena_SpicySoda_C) == 0x000968, "Member 'AB_Prj_Athena_SpicySoda_C::UberGraphFrame_B_Prj_Athena_SpicySoda_C' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, Proj_Trail) == 0x000970, "Member 'AB_Prj_Athena_SpicySoda_C::Proj_Trail' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, SK_ChugBomb) == 0x000978, "Member 'AB_Prj_Athena_SpicySoda_C::SK_ChugBomb' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, Audio_InAirLoop) == 0x000980, "Member 'AB_Prj_Athena_SpicySoda_C::Audio_InAirLoop' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, PlayerPawn) == 0x000988, "Member 'AB_Prj_Athena_SpicySoda_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HitLocation) == 0x000990, "Member 'AB_Prj_Athena_SpicySoda_C::HitLocation' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HitNormal) == 0x00099C, "Member 'AB_Prj_Athena_SpicySoda_C::HitNormal' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HealthHealAmount) == 0x0009A8, "Member 'AB_Prj_Athena_SpicySoda_C::HealthHealAmount' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, ShieldHealAmount) == 0x0009AC, "Member 'AB_Prj_Athena_SpicySoda_C::ShieldHealAmount' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, MaxHealAmount) == 0x0009B0, "Member 'AB_Prj_Athena_SpicySoda_C::MaxHealAmount' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, MaxHealValue) == 0x0009B8, "Member 'AB_Prj_Athena_SpicySoda_C::MaxHealValue' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HealPool_Duration) == 0x0009E0, "Member 'AB_Prj_Athena_SpicySoda_C::HealPool_Duration' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, GrantHealth) == 0x000A08, "Member 'AB_Prj_Athena_SpicySoda_C::GrantHealth' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, GrantShield) == 0x000A09, "Member 'AB_Prj_Athena_SpicySoda_C::GrantShield' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HealOnlyFX) == 0x000A10, "Member 'AB_Prj_Athena_SpicySoda_C::HealOnlyFX' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, Stopped) == 0x000A18, "Member 'AB_Prj_Athena_SpicySoda_C::Stopped' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HitActors) == 0x000A20, "Member 'AB_Prj_Athena_SpicySoda_C::HitActors' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, HitPlayerPawn) == 0x000A30, "Member 'AB_Prj_Athena_SpicySoda_C::HitPlayerPawn' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, Owning_Player_Quest_Manager) == 0x000A38, "Member 'AB_Prj_Athena_SpicySoda_C::Owning_Player_Quest_Manager' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, Heal_Teammate_TC) == 0x000A40, "Member 'AB_Prj_Athena_SpicySoda_C::Heal_Teammate_TC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, Heal_Squadmate_TC) == 0x000A60, "Member 'AB_Prj_Athena_SpicySoda_C::Heal_Squadmate_TC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, WaterTraceRadius) == 0x000A80, "Member 'AB_Prj_Athena_SpicySoda_C::WaterTraceRadius' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, WaterTraceObjectTypes) == 0x000A88, "Member 'AB_Prj_Athena_SpicySoda_C::WaterTraceObjectTypes' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, LandscapeExtinguishRadius) == 0x000A98, "Member 'AB_Prj_Athena_SpicySoda_C::LandscapeExtinguishRadius' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_SpicySoda_C, TraceIgnoreTags) == 0x000AA0, "Member 'AB_Prj_Athena_SpicySoda_C::TraceIgnoreTags' has a wrong offset!");
