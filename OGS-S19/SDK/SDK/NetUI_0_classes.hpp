...
static_assert(sizeof(UNetUI_C) == 0x0002B8, "Wrong size on UNetUI_C");
static_assert(offsetof(UNetUI_C, NetDebugContainer) == 0x0002B0, "Member 'UNetUI_C::NetDebugContainer' has a wrong offset!");
