...
static_assert(sizeof(UAthenaQuickBarSlot_C) == 0x000488, "Wrong size on UAthenaQuickBarSlot_C");
static_assert(offsetof(UAthenaQuickBarSlot_C, UberGraphFrame_AthenaQuickBarSlot_C) == 0x000480, "Member 'UAthenaQuickBarSlot_C::UberGraphFrame_AthenaQuickBarSlot_C' has a wrong offset!");
