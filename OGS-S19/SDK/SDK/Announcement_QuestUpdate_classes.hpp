...
static_assert(sizeof(UAnnouncement_QuestUpdate_C) == 0x000288, "Wrong size on UAnnouncement_QuestUpdate_C");
static_assert(offsetof(UAnnouncement_QuestUpdate_C, UberGraphFrame) == 0x000278, "Member 'UAnnouncement_QuestUpdate_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAnnouncement_QuestUpdate_C, QuestUpdateEntry) == 0x000280, "Member 'UAnnouncement_QuestUpdate_C::QuestUpdateEntry' has a wrong offset!");
