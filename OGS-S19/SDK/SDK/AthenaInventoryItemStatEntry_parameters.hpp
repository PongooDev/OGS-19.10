...
static_assert(sizeof(AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry) == 0x0000B8, "Wrong size on AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry");
...
static_assert(offsetof(AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry, CallFunc_GetDynamicMaterial_ReturnValue_1) == 0x000010, "Member 'AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry::CallFunc_GetDynamicMaterial_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry, K2Node_Event_ItemRarity) == 0x000018, "Member 'AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry::K2Node_Event_ItemRarity' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry, K2Node_Event_RarityItemData) == 0x000020, "Member 'AthenaInventoryItemStatEntry_C_ExecuteUbergraph_AthenaInventoryItemStatEntry::K2Node_Event_RarityItemData' has a wrong offset!");
