...
static_assert(sizeof(AB_ShieldFlopper_Weap_Athena_C) == 0x001480, "Wrong size on AB_ShieldFlopper_Weap_Athena_C");
static_assert(offsetof(AB_ShieldFlopper_Weap_Athena_C, Shield_Fish) == 0x001470, "Member 'AB_ShieldFlopper_Weap_Athena_C::Shield_Fish' has a wrong offset!");
static_assert(offsetof(AB_ShieldFlopper_Weap_Athena_C, P_Flopper_Catch_Drips) == 0x001478, "Member 'AB_ShieldFlopper_Weap_Athena_C::P_Flopper_Catch_Drips' has a wrong offset!");
