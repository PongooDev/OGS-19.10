...
static_assert(sizeof(KillerInfoWeaponWidget_C_ExecuteUbergraph_KillerInfoWeaponWidget) == 0x0001A8, "Wrong size on KillerInfoWeaponWidget_C_ExecuteUbergraph_KillerInfoWeaponWidget");
...
static_assert(offsetof(KillerInfoWeaponWidget_C_ExecuteUbergraph_KillerInfoWeaponWidget, K2Node_MakeArray_Array) == 0x000180, "Member 'KillerInfoWeaponWidget_C_ExecuteUbergraph_KillerInfoWeaponWidget::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(KillerInfoWeaponWidget_C_ExecuteUbergraph_KillerInfoWeaponWidget, CallFunc_Format_ReturnValue) == 0x000190, "Member 'KillerInfoWeaponWidget_C_ExecuteUbergraph_KillerInfoWeaponWidget::CallFunc_Format_ReturnValue' has a wrong offset!");
