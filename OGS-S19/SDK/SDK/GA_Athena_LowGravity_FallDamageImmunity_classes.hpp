...
static_assert(sizeof(UGA_Athena_LowGravity_FallDamageImmunity_C) == 0x000AD0, "Wrong size on UGA_Athena_LowGravity_FallDamageImmunity_C");
static_assert(offsetof(UGA_Athena_LowGravity_FallDamageImmunity_C, UberGraphFrame_GA_Athena_LowGravity_FallDamageImmunity_C) == 0x000AC0, "Member 'UGA_Athena_LowGravity_FallDamageImmunity_C::UberGraphFrame_GA_Athena_LowGravity_FallDamageImmunity_C' has a wrong offset!");
static_assert(offsetof(UGA_Athena_LowGravity_FallDamageImmunity_C, PlayerPawn) == 0x000AC8, "Member 'UGA_Athena_LowGravity_FallDamageImmunity_C::PlayerPawn' has a wrong offset!");
