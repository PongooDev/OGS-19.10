...
static_assert(sizeof(UGA_Athena_FloppingRabbit_Pull_C) == 0x000B70, "Wrong size on UGA_Athena_FloppingRabbit_Pull_C");
...
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, AITarget) == 0x000AC0, "Member 'UGA_Athena_FloppingRabbit_Pull_C::AITarget' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, T_InVehicle) == 0x000AC8, "Member 'UGA_Athena_FloppingRabbit_Pull_C::T_InVehicle' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, LaunchArc) == 0x000AD0, "Member 'UGA_Athena_FloppingRabbit_Pull_C::LaunchArc' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, LaunchGrav) == 0x000AD4, "Member 'UGA_Athena_FloppingRabbit_Pull_C::LaunchGrav' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, Row_PullAmount) == 0x000AD8, "Member 'UGA_Athena_FloppingRabbit_Pull_C::Row_PullAmount' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, Row_PullEnabled) == 0x000B00, "Member 'UGA_Athena_FloppingRabbit_Pull_C::Row_PullEnabled' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, Row_CanPullFriends) == 0x000B28, "Member 'UGA_Athena_FloppingRabbit_Pull_C::Row_CanPullFriends' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_Pull_C, TC_TagsForAIToIgnoreLaunch) == 0x000B50, "Member 'UGA_Athena_FloppingRabbit_Pull_C::TC_TagsForAIToIgnoreLaunch' has a wrong offset!");
