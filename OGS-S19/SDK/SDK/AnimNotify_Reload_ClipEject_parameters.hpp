...
static_assert(offsetof(AnimNotify_Reload_ClipEject_C_Received_Notify, CallFunc_SpawnEmitterAttached_ReturnValue) == 0x000040, "Member 'AnimNotify_Reload_ClipEject_C_Received_Notify::CallFunc_SpawnEmitterAttached_ReturnValue' has a wrong offset!");
