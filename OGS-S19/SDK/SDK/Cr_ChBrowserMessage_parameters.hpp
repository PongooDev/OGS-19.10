...
static_assert(sizeof(Cr_ChBrowserMessage_C_Populate) == 0x0000C8, "Wrong size on Cr_ChBrowserMessage_C_Populate");
...
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, K2Node_MakeStruct_SlateColor_1) == 0x000084, "Member 'Cr_ChBrowserMessage_C_Populate::K2Node_MakeStruct_SlateColor_1' has a wrong offset!");
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, K2Node_Select_Default) == 0x000098, "Member 'Cr_ChBrowserMessage_C_Populate::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, K2Node_Select_Default_1) == 0x0000AC, "Member 'Cr_ChBrowserMessage_C_Populate::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, K2Node_Select_Default_2) == 0x0000AD, "Member 'Cr_ChBrowserMessage_C_Populate::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, K2Node_Select_Default_3) == 0x0000B0, "Member 'Cr_ChBrowserMessage_C_Populate::K2Node_Select_Default_3' has a wrong offset!");
