...
static_assert(sizeof(AB_EffectiveFlopper_Weap_Athena_C) == 0x001478, "Wrong size on AB_EffectiveFlopper_Weap_Athena_C");
static_assert(offsetof(AB_EffectiveFlopper_Weap_Athena_C, P_Flopper_Catch_Drips) == 0x001470, "Member 'AB_EffectiveFlopper_Weap_Athena_C::P_Flopper_Catch_Drips' has a wrong offset!");
