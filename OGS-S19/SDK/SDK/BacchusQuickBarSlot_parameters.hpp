...
static_assert(alignof(BacchusQuickbarSlot_C_OnExtensionWidgetAdded) == 0x000008, "Wrong alignment on BacchusQuickbarSlot_C_OnExtensionWidgetAdded");
static_assert(sizeof(BacchusQuickbarSlot_C_OnExtensionWidgetAdded) == 0x000010, "Wrong size on BacchusQuickbarSlot_C_OnExtensionWidgetAdded");
static_assert(offsetof(BacchusQuickbarSlot_C_OnExtensionWidgetAdded, ExtensionSlot) == 0x000000, "Member 'BacchusQuickbarSlot_C_OnExtensionWidgetAdded::ExtensionSlot' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_OnExtensionWidgetAdded, ExtensionWidget) == 0x000008, "Member 'BacchusQuickbarSlot_C_OnExtensionWidgetAdded::ExtensionWidget' has a wrong offset!");
...
static_assert(sizeof(BacchusQuickbarSlot_C_OnDrop) == 0x0000E8, "Wrong size on BacchusQuickbarSlot_C_OnDrop");
...
static_assert(offsetof(BacchusQuickbarSlot_C_OnDrop, CallFunc_Not_PreBool_ReturnValue) == 0x0000C1, "Member 'BacchusQuickbarSlot_C_OnDrop::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BacchusQuickbarSlot_C_OnDrop, CallFunc_GetContext_ReturnValue) == 0x0000D8, "Member 'BacchusQuickbarSlot_C_OnDrop::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_OnDrop, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0000E0, "Member 'BacchusQuickbarSlot_C_OnDrop::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_OnDrop, CallFunc_DropItemOnQuickBar_ReturnValue) == 0x0000E1, "Member 'BacchusQuickbarSlot_C_OnDrop::CallFunc_DropItemOnQuickBar_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BacchusQuickbarSlot_C_Handle_Drop_Item_Confirmation_Callback) == 0x000030, "Wrong size on BacchusQuickbarSlot_C_Handle_Drop_Item_Confirmation_Callback");
...
static_assert(offsetof(BacchusQuickbarSlot_C_Handle_Drop_Item_Confirmation_Callback, CallFunc_DropItem_ReturnValue) == 0x000028, "Member 'BacchusQuickbarSlot_C_Handle_Drop_Item_Confirmation_Callback::CallFunc_DropItem_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot) == 0x0001F8, "Wrong size on BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot");
...
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, CallFunc_DropItem_ReturnValue) == 0x0001C9, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::CallFunc_DropItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, K2Node_CustomEvent_QuickbarIndex) == 0x0001CA, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::K2Node_CustomEvent_QuickbarIndex' has a wrong offset!");
...
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, CallFunc_Not_PreBool_ReturnValue) == 0x0001E0, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, CallFunc_BooleanAND_ReturnValue) == 0x0001E1, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, K2Node_Event_ExtensionSlot) == 0x0001E2, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::K2Node_Event_ExtensionSlot' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, K2Node_Event_ExtensionWidget) == 0x0001E8, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::K2Node_Event_ExtensionWidget' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot, CallFunc_AddChildToOverlay_ReturnValue) == 0x0001F0, "Member 'BacchusQuickbarSlot_C_ExecuteUbergraph_BacchusQuickbarSlot::CallFunc_AddChildToOverlay_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BacchusQuickbarSlot_C_End_Interaction_BP) == 0x000001, "Wrong alignment on BacchusQuickbarSlot_C_End_Interaction_BP");
static_assert(sizeof(BacchusQuickbarSlot_C_End_Interaction_BP) == 0x000008, "Wrong size on BacchusQuickbarSlot_C_End_Interaction_BP");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, DragAttempted) == 0x000000, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::DragAttempted' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_Not_PreBool_ReturnValue) == 0x000001, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_Not_PreBool_ReturnValue_1) == 0x000002, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_BooleanAND_ReturnValue) == 0x000003, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_BooleanAND_ReturnValue_1) == 0x000004, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_IsDragDropping_ReturnValue) == 0x000005, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_IsDragDropping_ReturnValue' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_BooleanAND_ReturnValue_2) == 0x000006, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BacchusQuickbarSlot_C_End_Interaction_BP, CallFunc_BooleanOR_ReturnValue) == 0x000007, "Member 'BacchusQuickbarSlot_C_End_Interaction_BP::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
