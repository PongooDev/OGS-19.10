...
static_assert(sizeof(GA_Athena_ChillBronco_C_ExecuteUbergraph_GA_Athena_ChillBronco) == 0x000038, "Wrong size on GA_Athena_ChillBronco_C_ExecuteUbergraph_GA_Athena_ChillBronco");
...
static_assert(offsetof(GA_Athena_ChillBronco_C_ExecuteUbergraph_GA_Athena_ChillBronco, CallFunc_SendComplexCustomStatEvent_QuestActive) == 0x000030, "Member 'GA_Athena_ChillBronco_C_ExecuteUbergraph_GA_Athena_ChillBronco::CallFunc_SendComplexCustomStatEvent_QuestActive' has a wrong offset!");
static_assert(offsetof(GA_Athena_ChillBronco_C_ExecuteUbergraph_GA_Athena_ChillBronco, CallFunc_SendComplexCustomStatEvent_QuestCompleted) == 0x000031, "Member 'GA_Athena_ChillBronco_C_ExecuteUbergraph_GA_Athena_ChillBronco::CallFunc_SendComplexCustomStatEvent_QuestCompleted' has a wrong offset!");
