...
static_assert(sizeof(APrj_Athena_Bucket_Old_C) == 0x0009A8, "Wrong size on APrj_Athena_Bucket_Old_C");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, UberGraphFrame_Prj_Athena_Bucket_Old_C) == 0x000968, "Member 'APrj_Athena_Bucket_Old_C::UberGraphFrame_Prj_Athena_Bucket_Old_C' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ItemToSpawn) == 0x000970, "Member 'APrj_Athena_Bucket_Old_C::ItemToSpawn' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, TurnOffFX) == 0x000978, "Member 'APrj_Athena_Bucket_Old_C::TurnOffFX' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, HitMarkerSound) == 0x000980, "Member 'APrj_Athena_Bucket_Old_C::HitMarkerSound' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ThrowIndicator_SoundRef) == 0x000988, "Member 'APrj_Athena_Bucket_Old_C::ThrowIndicator_SoundRef' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ShouldSpawnItem) == 0x000990, "Member 'APrj_Athena_Bucket_Old_C::ShouldSpawnItem' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, Splash_Sound_0) == 0x000998, "Member 'APrj_Athena_Bucket_Old_C::Splash_Sound_0' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ImpactSpawnOffset) == 0x0009A0, "Member 'APrj_Athena_Bucket_Old_C::ImpactSpawnOffset' has a wrong offset!");
