...
static_assert(sizeof(AB_Rifle_Sniper_Heavy_Athena_C) == 0x001AB8, "Wrong size on AB_Rifle_Sniper_Heavy_Athena_C");
static_assert(offsetof(AB_Rifle_Sniper_Heavy_Athena_C, UberGraphFrame_B_Rifle_Sniper_Heavy_Athena_C) == 0x001AB0, "Member 'AB_Rifle_Sniper_Heavy_Athena_C::UberGraphFrame_B_Rifle_Sniper_Heavy_Athena_C' has a wrong offset!");
