...
static_assert(sizeof(ACreative_Device_Prop_Parent_C) == 0x000DD8, "Wrong size on ACreative_Device_Prop_Parent_C");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, UberGraphFrame) == 0x000D58, "Member 'ACreative_Device_Prop_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, VisibleInGameComponent) == 0x000D60, "Member 'ACreative_Device_Prop_Parent_C::VisibleInGameComponent' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, EnabledComponent) == 0x000D68, "Member 'ACreative_Device_Prop_Parent_C::EnabledComponent' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, FortMinigameProgress) == 0x000D70, "Member 'ACreative_Device_Prop_Parent_C::FortMinigameProgress' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, ToyOptionsComponent) == 0x000D78, "Member 'ACreative_Device_Prop_Parent_C::ToyOptionsComponent' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, ActivateOnGamePhase) == 0x000D80, "Member 'ACreative_Device_Prop_Parent_C::ActivateOnGamePhase' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, EnabledIndex) == 0x000D84, "Member 'ACreative_Device_Prop_Parent_C::EnabledIndex' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, On_Device_Activated) == 0x000D88, "Member 'ACreative_Device_Prop_Parent_C::On_Device_Activated' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, Instigating_Controller) == 0x000D98, "Member 'ACreative_Device_Prop_Parent_C::Instigating_Controller' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, bIsVisible) == 0x000DA0, "Member 'ACreative_Device_Prop_Parent_C::bIsVisible' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, On_Device_Initialized) == 0x000DA8, "Member 'ACreative_Device_Prop_Parent_C::On_Device_Initialized' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, On_Play_Mode_Changed) == 0x000DB8, "Member 'ACreative_Device_Prop_Parent_C::On_Play_Mode_Changed' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, Update_on_Minigame_State_Change) == 0x000DC8, "Member 'ACreative_Device_Prop_Parent_C::Update_on_Minigame_State_Change' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, Update_on_Play_Mode_Changed) == 0x000DC9, "Member 'ACreative_Device_Prop_Parent_C::Update_on_Play_Mode_Changed' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, Initialize_during_Preview) == 0x000DCA, "Member 'ACreative_Device_Prop_Parent_C::Initialize_during_Preview' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, MaxHealth) == 0x000DCC, "Member 'ACreative_Device_Prop_Parent_C::MaxHealth' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, MaxHealthEffectHandler) == 0x000DD0, "Member 'ACreative_Device_Prop_Parent_C::MaxHealthEffectHandler' has a wrong offset!");
