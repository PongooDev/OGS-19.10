...
static_assert(alignof(Cr_ChBrowserDeviceTile_C_UpdateArt) == 0x000010, "Wrong alignment on Cr_ChBrowserDeviceTile_C_UpdateArt");
static_assert(sizeof(Cr_ChBrowserDeviceTile_C_UpdateArt) == 0x0000C0, "Wrong size on Cr_ChBrowserDeviceTile_C_UpdateArt");
...
static_assert(offsetof(Cr_ChBrowserDeviceTile_C_UpdateArt, inSlateBrush) == 0x000010, "Member 'Cr_ChBrowserDeviceTile_C_UpdateArt::inSlateBrush' has a wrong offset!");
