...
static_assert(sizeof(UItemDetailsHeaderItemDisplayText_C) == 0x0002D8, "Wrong size on UItemDetailsHeaderItemDisplayText_C");
static_assert(offsetof(UItemDetailsHeaderItemDisplayText_C, UberGraphFrame) == 0x0002C8, "Member 'UItemDetailsHeaderItemDisplayText_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemDetailsHeaderItemDisplayText_C, ItemDisplayName) == 0x0002D0, "Member 'UItemDetailsHeaderItemDisplayText_C::ItemDisplayName' has a wrong offset!");
