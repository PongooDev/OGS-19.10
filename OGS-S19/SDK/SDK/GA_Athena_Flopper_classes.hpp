...
static_assert(sizeof(UGA_Athena_Flopper_C) == 0x000C78, "Wrong size on UGA_Athena_Flopper_C");
static_assert(offsetof(UGA_Athena_Flopper_C, UberGraphFrame_GA_Athena_Flopper_C) == 0x000C70, "Member 'UGA_Athena_Flopper_C::UberGraphFrame_GA_Athena_Flopper_C' has a wrong offset!");
