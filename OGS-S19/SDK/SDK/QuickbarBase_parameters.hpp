...
static_assert(offsetof(QuickbarBase_C_RefreshQuickbar, ForceItemsChanged) == 0x000000, "Member 'QuickbarBase_C_RefreshQuickbar::ForceItemsChanged' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_RefreshQuickbar, Temp_int_Array_Index_Variable) == 0x000004, "Member 'QuickbarBase_C_RefreshQuickbar::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_RefreshQuickbar, Temp_int_Loop_Counter_Variable) == 0x000008, "Member 'QuickbarBase_C_RefreshQuickbar::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_RefreshQuickbar, CallFunc_Add_IntInt_ReturnValue) == 0x00000C, "Member 'QuickbarBase_C_RefreshQuickbar::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuickbarBase_C_RefreshQuickbar, CallFunc_Array_Length_ReturnValue) == 0x000018, "Member 'QuickbarBase_C_RefreshQuickbar::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_RefreshQuickbar, CallFunc_Less_IntInt_ReturnValue) == 0x00001C, "Member 'QuickbarBase_C_RefreshQuickbar::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	TDelegate<void(struct FFortPlayerDeathReport& DeathReport)> K2Node_CreateDelegate_OutputDelegate_16;           // 0x02D4(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(EFortQuickBars QuickbarIndex, TArray<int32>& ChangedSlots)> K2Node_CreateDelegate_OutputDelegate_23;           // 0x0378(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetVolumeManager_OutVolumeManager) == 0x000218, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetVolumeManager_OutVolumeManager' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetVolumeManager_OutIsValid) == 0x000220, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetVolumeManager_OutIsValid' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_SwitchEnum_CmpSuccess) == 0x000221, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue) == 0x000222, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetContext_ReturnValue_2) == 0x000228, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetContext_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CustomEvent_Client_1) == 0x000238, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CustomEvent_Client_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CustomEvent_Volume_1) == 0x000240, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CustomEvent_Volume_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetMinigameForVolume_ReturnValue) == 0x000248, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetMinigameForVolume_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue_1) == 0x000250, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue_2) == 0x000251, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_12) == 0x000254, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_12' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_13) == 0x000264, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_13' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CustomEvent_Client) == 0x000278, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CustomEvent_Client' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CustomEvent_Volume) == 0x000280, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CustomEvent_Volume' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_14) == 0x000288, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_14' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetMinigameForVolume_ReturnValue_1) == 0x000298, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetMinigameForVolume_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue_3) == 0x0002A0, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue_4) == 0x0002A1, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetOwningPlayer_ReturnValue) == 0x0002A8, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_15) == 0x0002B0, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_15' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue_5) == 0x0002C0, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetVolumeForPlayerState_ReturnValue) == 0x0002C8, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetVolumeForPlayerState_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_IsValid_ReturnValue_6) == 0x0002D0, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_IsValid_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_16) == 0x0002D4, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_16' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_17) == 0x0002E4, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_17' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_18) == 0x0002F4, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_18' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetContext_ReturnValue_4) == 0x000308, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetContext_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, Temp_int_Loop_Counter_Variable_1) == 0x000310, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_Less_IntInt_ReturnValue_1) == 0x000314, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_Add_IntInt_ReturnValue_1) == 0x000318, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, Temp_int_Array_Index_Variable_1) == 0x00031C, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_Array_Get_Item_4) == 0x000320, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_19) == 0x000328, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_19' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_ShouldRefreshQuickbarItem_Result_1) == 0x000338, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_ShouldRefreshQuickbarItem_Result_1' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_20) == 0x00033C, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_20' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_21) == 0x00034C, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_21' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_GetContext_ReturnValue_5) == 0x000360, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_GetContext_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_22) == 0x000368, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_22' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, K2Node_CreateDelegate_OutputDelegate_23) == 0x000378, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::K2Node_CreateDelegate_OutputDelegate_23' has a wrong offset!");
static_assert(offsetof(QuickbarBase_C_ExecuteUbergraph_QuickbarBase, CallFunc_EqualEqual_ByteByte_ReturnValue_3) == 0x000388, "Member 'QuickbarBase_C_ExecuteUbergraph_QuickbarBase::CallFunc_EqualEqual_ByteByte_ReturnValue_3' has a wrong offset!");
