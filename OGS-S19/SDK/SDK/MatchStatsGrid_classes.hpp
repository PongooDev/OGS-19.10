...
static_assert(sizeof(UMatchStatsGrid_C) == 0x000250, "Wrong size on UMatchStatsGrid_C");
static_assert(offsetof(UMatchStatsGrid_C, ProfileStatBox) == 0x000248, "Member 'UMatchStatsGrid_C::ProfileStatBox' has a wrong offset!");
