...
static_assert(sizeof(UGA_Shotgun_DoubleDouble_Damage_C) == 0x000B00, "Wrong size on UGA_Shotgun_DoubleDouble_Damage_C");
static_assert(offsetof(UGA_Shotgun_DoubleDouble_Damage_C, UberGraphFrame) == 0x000AF0, "Member 'UGA_Shotgun_DoubleDouble_Damage_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Shotgun_DoubleDouble_Damage_C, GE_SelfKnock) == 0x000AF8, "Member 'UGA_Shotgun_DoubleDouble_Damage_C::GE_SelfKnock' has a wrong offset!");
