...
static_assert(sizeof(UGA_WaffleTruck_TrackingPistol_Indicator_C) == 0x000B08, "Wrong size on UGA_WaffleTruck_TrackingPistol_Indicator_C");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, HitActors) == 0x000AB0, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::HitActors' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, IndicatorParticleSystem) == 0x000AC0, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::IndicatorParticleSystem' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, IndicatorActorParamName) == 0x000AC8, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::IndicatorActorParamName' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, IndicatorVectorParamName) == 0x000AD0, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::IndicatorVectorParamName' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, IndicatorGroupID) == 0x000AD8, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::IndicatorGroupID' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, IndicatorDuration) == 0x000AE8, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::IndicatorDuration' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, IndicatorSound) == 0x000AF0, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::IndicatorSound' has a wrong offset!");
static_assert(offsetof(UGA_WaffleTruck_TrackingPistol_Indicator_C, EnemyMarkingGE) == 0x000AF8, "Member 'UGA_WaffleTruck_TrackingPistol_Indicator_C::EnemyMarkingGE' has a wrong offset!");
