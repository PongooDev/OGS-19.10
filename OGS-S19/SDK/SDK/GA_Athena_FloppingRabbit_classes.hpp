...
static_assert(sizeof(UGA_Athena_FloppingRabbit_C) == 0x000E88, "Wrong size on UGA_Athena_FloppingRabbit_C");
static_assert(offsetof(UGA_Athena_FloppingRabbit_C, UberGraphFrame_GA_Athena_FloppingRabbit_C) == 0x000E58, "Member 'UGA_Athena_FloppingRabbit_C::UberGraphFrame_GA_Athena_FloppingRabbit_C' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_C, T_Active) == 0x000E60, "Member 'UGA_Athena_FloppingRabbit_C::T_Active' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_C, T_InWorld) == 0x000E68, "Member 'UGA_Athena_FloppingRabbit_C::T_InWorld' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_C, CastMontageWeapon) == 0x000E70, "Member 'UGA_Athena_FloppingRabbit_C::CastMontageWeapon' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_C, OpenSeatTag) == 0x000E78, "Member 'UGA_Athena_FloppingRabbit_C::OpenSeatTag' has a wrong offset!");
static_assert(offsetof(UGA_Athena_FloppingRabbit_C, InVehicleTag) == 0x000E80, "Member 'UGA_Athena_FloppingRabbit_C::InVehicleTag' has a wrong offset!");
