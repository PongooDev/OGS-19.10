...
static_assert(sizeof(ItemCostWidget_C_SetRarityData) == 0x0002B0, "Wrong size on ItemCostWidget_C_SetRarityData");
...
static_assert(offsetof(ItemCostWidget_C_SetRarityData, K2Node_MakeStruct_SlateBrush_1) == 0x000140, "Member 'ItemCostWidget_C_SetRarityData::K2Node_MakeStruct_SlateBrush_1' has a wrong offset!");
static_assert(offsetof(ItemCostWidget_C_SetRarityData, K2Node_Select_Default) == 0x0001F0, "Member 'ItemCostWidget_C_SetRarityData::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ItemCostWidget_C_SetRarityData, CallFunc_IsValid_ReturnValue) == 0x0002A0, "Member 'ItemCostWidget_C_SetRarityData::CallFunc_IsValid_ReturnValue' has a wrong offset!");
