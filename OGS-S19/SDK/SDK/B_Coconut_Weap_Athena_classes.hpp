...
static_assert(sizeof(AB_Coconut_Weap_Athena_C) == 0x001478, "Wrong size on AB_Coconut_Weap_Athena_C");
static_assert(offsetof(AB_Coconut_Weap_Athena_C, StaticMesh) == 0x001470, "Member 'AB_Coconut_Weap_Athena_C::StaticMesh' has a wrong offset!");
