...
static_assert(sizeof(NetDebugUI_C_SetTextStyleForMobile) == 0x000088, "Wrong size on NetDebugUI_C_SetTextStyleForMobile");
...
static_assert(offsetof(NetDebugUI_C_SetTextStyleForMobile, CallFunc_Add_IntInt_ReturnValue) == 0x000080, "Member 'NetDebugUI_C_SetTextStyleForMobile::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
