...
static_assert(sizeof(AB_PhysicsTree_Reporter_C) == 0x000240, "Wrong size on AB_PhysicsTree_Reporter_C");
static_assert(offsetof(AB_PhysicsTree_Reporter_C, UberGraphFrame) == 0x000220, "Member 'AB_PhysicsTree_Reporter_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_PhysicsTree_Reporter_C, Scene) == 0x000228, "Member 'AB_PhysicsTree_Reporter_C::Scene' has a wrong offset!");
static_assert(offsetof(AB_PhysicsTree_Reporter_C, PhysicsLogData) == 0x000230, "Member 'AB_PhysicsTree_Reporter_C::PhysicsLogData' has a wrong offset!");
