...
static_assert(sizeof(UAthenaDetachRCPawn_C) == 0x0002C0, "Wrong size on UAthenaDetachRCPawn_C");
static_assert(offsetof(UAthenaDetachRCPawn_C, HBox_DetachRCPawn) == 0x0002B0, "Member 'UAthenaDetachRCPawn_C::HBox_DetachRCPawn' has a wrong offset!");
static_assert(offsetof(UAthenaDetachRCPawn_C, KeybindWidget) == 0x0002B8, "Member 'UAthenaDetachRCPawn_C::KeybindWidget' has a wrong offset!");
