...
static_assert(sizeof(AthenaInventoryItemInfo_C_OnMouseButtonDown) == 0x000230, "Wrong size on AthenaInventoryItemInfo_C_OnMouseButtonDown");
...
static_assert(offsetof(AthenaInventoryItemInfo_C_OnMouseButtonDown, MouseEvent) == 0x000038, "Member 'AthenaInventoryItemInfo_C_OnMouseButtonDown::MouseEvent' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemInfo_C_OnMouseButtonDown, ReturnValue) == 0x0000A8, "Member 'AthenaInventoryItemInfo_C_OnMouseButtonDown::ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemInfo_C_OnMouseButtonDown, CallFunc_Not_PreBool_ReturnValue) == 0x000160, "Member 'AthenaInventoryItemInfo_C_OnMouseButtonDown::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemInfo_C_OnMouseButtonDown, CallFunc_PlayAnimationReverse_ReturnValue) == 0x000168, "Member 'AthenaInventoryItemInfo_C_OnMouseButtonDown::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemInfo_C_OnMouseButtonDown, CallFunc_PlayAnimationForward_ReturnValue) == 0x000170, "Member 'AthenaInventoryItemInfo_C_OnMouseButtonDown::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryItemInfo_C_OnMouseButtonDown, CallFunc_Handled_ReturnValue) == 0x000178, "Member 'AthenaInventoryItemInfo_C_OnMouseButtonDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
