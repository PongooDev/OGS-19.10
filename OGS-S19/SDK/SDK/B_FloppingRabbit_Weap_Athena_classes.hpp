...
static_assert(sizeof(AB_FloppingRabbit_Weap_Athena_C) == 0x001490, "Wrong size on AB_FloppingRabbit_Weap_Athena_C");
static_assert(offsetof(AB_FloppingRabbit_Weap_Athena_C, UberGraphFrame_B_FloppingRabbit_Weap_Athena_C) == 0x001470, "Member 'AB_FloppingRabbit_Weap_Athena_C::UberGraphFrame_B_FloppingRabbit_Weap_Athena_C' has a wrong offset!");
static_assert(offsetof(AB_FloppingRabbit_Weap_Athena_C, Projectile) == 0x001478, "Member 'AB_FloppingRabbit_Weap_Athena_C::Projectile' has a wrong offset!");
static_assert(offsetof(AB_FloppingRabbit_Weap_Athena_C, Wire) == 0x001480, "Member 'AB_FloppingRabbit_Weap_Athena_C::Wire' has a wrong offset!");
static_assert(offsetof(AB_FloppingRabbit_Weap_Athena_C, HideBobber) == 0x001488, "Member 'AB_FloppingRabbit_Weap_Athena_C::HideBobber' has a wrong offset!");
static_assert(offsetof(AB_FloppingRabbit_Weap_Athena_C, OneHandGrip) == 0x001489, "Member 'AB_FloppingRabbit_Weap_Athena_C::OneHandGrip' has a wrong offset!");
