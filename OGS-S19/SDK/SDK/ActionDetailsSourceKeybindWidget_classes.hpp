...
static_assert(sizeof(UActionDetailsSourceKeybindWidget_C) == 0x000A70, "Wrong size on UActionDetailsSourceKeybindWidget_C");
static_assert(offsetof(UActionDetailsSourceKeybindWidget_C, ActionSource) == 0x000A60, "Member 'UActionDetailsSourceKeybindWidget_C::ActionSource' has a wrong offset!");
