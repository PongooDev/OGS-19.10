...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, K2Node_DynamicCast_AsFort_Player_State) == 0x000090, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::K2Node_DynamicCast_AsFort_Player_State' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, K2Node_DynamicCast_bSuccess_1) == 0x000098, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetStatForPlayer_ReturnValue) == 0x00009C, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetStatForPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_Subtract_IntInt_ReturnValue) == 0x0000A0, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, K2Node_Select_Default) == 0x0000E8, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::K2Node_Select_Default' has a wrong offset!");
