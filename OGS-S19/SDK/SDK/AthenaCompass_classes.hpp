...
static_assert(alignof(UAthenaCompass_C) == 0x000010, "Wrong alignment on UAthenaCompass_C");
static_assert(sizeof(UAthenaCompass_C) == 0x000740, "Wrong size on UAthenaCompass_C");
