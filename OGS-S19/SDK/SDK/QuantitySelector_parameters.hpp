...
static_assert(sizeof(QuantitySelector_C_SetupForInputMode) == 0x000520, "Wrong size on QuantitySelector_C_SetupForInputMode");
...
static_assert(offsetof(QuantitySelector_C_SetupForInputMode, CallFunc_GetBrushForKey_ReturnValue) == 0x0000D0, "Member 'QuantitySelector_C_SetupForInputMode::CallFunc_GetBrushForKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_SetupForInputMode, K2Node_MakeStruct_SliderStyle) == 0x0000E0, "Member 'QuantitySelector_C_SetupForInputMode::K2Node_MakeStruct_SliderStyle' has a wrong offset!");
...
static_assert(sizeof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector) == 0x000150, "Wrong size on QuantitySelector_C_ExecuteUbergraph_QuantitySelector");
...
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Subtract_IntInt_ReturnValue_1) == 0x00011C, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Subtract_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Subtract_IntInt_ReturnValue_2) == 0x000120, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Subtract_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x000124, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Conv_IntToFloat_ReturnValue_2) == 0x000128, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Conv_IntToFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_GetMinValue_MinValue) == 0x00012C, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_GetMinValue_MinValue' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000130, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Subtract_IntInt_ReturnValue_3) == 0x000134, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Subtract_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Conv_IntToFloat_ReturnValue_3) == 0x000138, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Conv_IntToFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Conv_IntToFloat_ReturnValue_4) == 0x00013C, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Conv_IntToFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x000140, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x000148, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
